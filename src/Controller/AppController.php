...
class AppController extends Controller
{
   /* public $components = ['Tool'];*/
    ...
    {
        $this->Auth->allow(['quantityUpdate','emptyCart','inFo','addToCart','confirm','index', 'latest', 'view', 'getKeyword', 'search', 'menu','viewCart','changePassword','signup','login','forgot','contactMe']);
